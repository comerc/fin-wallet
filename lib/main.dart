...
import 'package:fin_wallet/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<FinWalletFirebaseUser> userStream;
  FinWalletFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = finWalletFirebaseUserStream()
